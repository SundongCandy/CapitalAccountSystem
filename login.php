...
<body>
	...
	if(isset($_SESSION['admin'])){
		echo '<script> alert("The administrator has logged in! "); history.go(-1); </script>';
	}
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		if($isUserLegal && $isPsdLegal){
			if(checkAdministrator($user, $psd)){
				$_SESSION['admin'] = $user;
    ...
    function checkAdministrator($user, $psd){
