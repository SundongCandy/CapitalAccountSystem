...
<html>
<head>
	<title>Capital Account System - Cancel</title>
        ...
        <ul id="dashboard-menu">
            ...
            <li class="active">
                ...
                <ul class="active submenu">
                    ...
                    <li><a class="active" href="cancel.php">Cancel</a></li>
                </ul>
            </li>
            <li>
                <a href="myinfo.php">
        ...
        <div class="container-fluid">
            <div id="pad-wrapper">
            	...
            	<div class="form-page border-box">
					...
					<a class="button btn-flat info" href="withdraw.php">withdraw</a> &nbsp;<input class="button btn-flat primary" type="submit" value="comfirm cancel"/>				
				</div>		
