...
<html>
<head>
	<title>Capital Account System - Change Password</title>
        ...
        <ul id="dashboard-menu">
            ...
            <li class="active">
                ...
                <ul class="active submenu">
                    ...
                    <li><a class="active" href="modifypsd.php">Change Password</a></li>
        ...
        <div class="container-fluid">
            <div id="pad-wrapper">          
                ...
                <div class="row-fluid form-page border-box">
                	<div class="span6 form-wrapper-wide bio">  
                		<form action="" method="POST">             	
                            <div class="field-box">
                                <label>Original trading password:</label>
                                <input class="inline-input" type="password" name="oldpsd"/>
                            </div>                            
                            <div class="field-box">
                                <label>New trading password:</label>
                                <input class="inline-input" type="password" name="newpsd"/>
                            </div> 
                            <div class="field-box">
                                <label>Confirm:</label>
                                <input class="inline-input" type="password" name="newpsd2"/>
                            </div>
                            <input class="button btn-flat primary" type="submit" value="submit"/>
                         </form>

                       </div>
                    <div class="span6 form-wrapper-wide section">  
                		<form action="" method="POST">             	
                            <div class="field-box">
                                <label>Original withdraw password:</label>
                                <input class="inline-input" type="password" name="oldpsd"/>
                            </div>                            
                            <div class="field-box">
