...
<html>
<head>
	<title>Capital Account System - Report Loss</title>
        ...
        <ul id="dashboard-menu">
            ...
            <li class="active">
                ...
                <ul class="active submenu">
                    ...
                    <li><a class="active" href="lossreport.php">Report loss</a></li>
    ...
    <div class="content">
        ...
        <div class="container-fluid">
            <div id="pad-wrapper">
            	...
            	<div class="form-page border-box">
            		<div  class="span8">
                        ...
                        <form action="" method="POST"/>
                            <div class="field-box">
                                ...
                                <input class="span5" type="text" name="ID"/><input class="button2 btn-flat primary" type="submit" value="check"/>
                            </div>
					...
					<div class="span12 infobox2 biol">
						<div class="span12">
						  <label>Name:</label>
                          <p>xxxxxx</p>
                        </div>
						...
						<input class="button3 btn-flat primary" type="submit" value="comfirm submit"/>
				</div>		
